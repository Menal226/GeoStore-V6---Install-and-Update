GEOSTORE_URL = "https://portal.geostore.cz/v6/support/framework/AsyncJSON.ashx"
EDITOR_DOWNLOAD_URL = "https://portal.geostore.cz/v6/support/framework/AsyncJSON.ashx?action=repositoryFileDownload&path=&file=V6_HWKEY_x64.zip&output=zakladni_graficky_editor_GSV6_x64.zip&mode=attachment&method=stream"

IG_FULL_DOWNLOAD_URL = "https://portal.geostore.cz/v6/support/framework/AsyncJSON.ashx?action=repositoryFileDownload&path=&file=V6-IG_s_prostredim.zip&output=kompletn%C3%AD_instalace_aplikace_IG_HW_klic_x64.zip&mode=attachment&method=stream"
IG_PARTIAL_DOWNLOAD_URL = "https://portal.geostore.cz/v6/support/framework/AsyncJSON.ashx?action=repositoryFileDownload&path=&file=V6-IG.zip&output=castecna_instalace_aplikace_IG.zip&mode=attachment&method=stream"

DWG_DONWLOAD_URL = "https://portal.geostore.cz/v6/support/framework/AsyncJSON.ashx?action=repositoryFileDownload&path=&file=V6-DWG-DGN_x64.ZIP&output=instalace_roz%C5%A1%C3%AD%C5%99en%C3%AD_GSV6_DWG_DGN_x64.zip&mode=attachment&method=stream"
